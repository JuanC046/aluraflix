...
const Home = () => {
    ...
    useEffect(() => {
        getData().then((data) => {
            setVideos(data);
            setBannerVideo( {...data[0], borderColor: categories.find(category => category.name === data[0].category).color} );
        });
    }, [videos, bannerVideo]);
        ...
        <>
            ...
            <main>
                <Banner
                    ...
                    description={bannerVideo.description || "En esta navidad celebra con nosotros"}
                    image={bannerVideo.image || "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?q=80&w=1913&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
                ></Banner>
